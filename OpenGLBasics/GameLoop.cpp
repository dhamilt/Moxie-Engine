...
void GameLoop::SendLogMessage(MessageTypes messageType, std::string message, const char* fileName, int line, const char* function, ...)
{
	va_list args;
	va_start(args, function);
	logWindow->Message(messageType, message.c_str(), fileName, line, function, args);
	va_end(args);
}
